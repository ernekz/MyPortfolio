    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white p-4'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/92a18e9f-10ba-48ec-a724-dcc121aa4a5d" method='POST' className=' flex flex-col w-full md:w-1/2'>
                    <input type="text" 
                    name='name' 
                    ...
                    py-3 my-8 mx-auto flex items-center rounded-md hover:scale-105 duration-300'>Let's talk</button>
                </form>
            </div>
        </div>
