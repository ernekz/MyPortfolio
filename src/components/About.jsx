    ...
    <div name='about' className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            ...
            <p className='text-xl mt-20'>
                I am creative and innovative person willing to get out of my comfort zone to create different types of applications.
            ...
            <p className='text-xl'>
                ...
                work on my own projects to gain more experience in the field where I want to pursue my career in. I am a person who likes to help people
                where I can. 
